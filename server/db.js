...
function resolveTableName(fromPart) {
  const tables = {
    ...
    'plan_equipment': 'plan_equipment',
    'user_equipment_checks': 'user_equipment_checks',
    'p': 'plans',
    'pp': 'participants',
    'n': 'notes',
    'f': 'favorites',
